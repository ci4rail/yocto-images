...
fly -t dev set-pipeline -c pipeline_testing.yaml -p cpu01-edgefarm-acceptance-test -l ci/config-testing.yaml -l ci/config-dev.yaml -l ci/credentials.yaml -v name=cpu01-edgefarm
